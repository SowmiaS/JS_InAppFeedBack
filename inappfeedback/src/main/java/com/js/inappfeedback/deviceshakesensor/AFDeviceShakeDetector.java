package com.js.inappfeedback.deviceshakesensor;
 ...
 */
public class AFDeviceShakeDetector implements SensorEventListener {
    ...
    public AFDeviceShakeDetector(Context context, DeviceShakeListener mDeviceShakeListener) {
    ...
    public AFDeviceShakeDetector(Context context) {
        this.mContext = context;
        mSensorManager = (SensorManager)context.getSystemService(Context.SENSOR_SERVICE);
        mSensor = mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
        mSensorManager.registerListener((SensorEventListener) this, mSensor ,20);
    ...
    public void setmDeviceShakeListener(DeviceShakeListener mDeviceShakeListener) {
        this.mDeviceShakeListener = mDeviceShakeListener;
    }
